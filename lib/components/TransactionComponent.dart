      ...
      child: ListTile(
        ...
        title: Column(
          ...
          children: [
            ...
            SizedBox(height: 5,),
            Text(transaction['name'],style: TextStyle(fontWeight: FontWeight.w400,fontFamily: 'MTN Brighter Sans'),),
            SizedBox(height: 8,),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(transaction['date'],style: TextStyle(fontWeight: FontWeight.w400,fontSize : AppStyle.size12,fontFamily: 'MTN Brighter Sans',color: AppColors.greyColor),),
                Text('ID ${transaction['id']}',style: TextStyle(fontWeight: FontWeight.w400,fontSize : AppStyle.size12,fontFamily: 'MTN Brighter Sans',color: AppColors.greyColor),),
              ],
            ),
            SizedBox(height: 10,),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(transaction['amount'].toString() + ' CFA',style: TextStyle(fontWeight: FontWeight.w500,fontSize : AppStyle.size15,fontFamily: 'MTN Brighter Sans'),),
                Container(
